...
double kthLinearRecurrence(const vector<double>& a,
                           const vector<double>& c,
                           const double& k,
                           const double& m) {  // note this program doesn't do
    ...
    if (m <= k) {
        ...
        throw runtime_error(
            "no enough information about c to produce the result");
    }
}

// a program that calculates the fifth order recurrence without using array
double fifthOcurrence(const double& a1,
                      const double& a2,
                      const double& a3,
                      const double& a4,
                      const double& c1,
...
// below is a function does the job calculating occurence of any order using
// array
