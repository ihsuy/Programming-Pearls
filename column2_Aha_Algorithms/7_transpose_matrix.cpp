...
void matrix_show(const vector<int>& tape,
                 const int& n_row) {  // display a flat matrix(1d vector) in 2D
...
void transpose(
    ...
    const int& n_row) {  // transpose a matrix stored in format of 1d tape
    ...
    stable_sort(marked_matrix_tape.begin(), marked_matrix_tape.end(),
