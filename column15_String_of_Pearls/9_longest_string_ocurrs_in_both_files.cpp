...
string LongestCommonSubstring(const string& s1, const string& s2)
{
    ...
    auto merged_text = MergeStrings(s1.c_str(), len1,
                                    s2.c_str(), len2);
    ...
    return s1.substr(min(idx_arr[max_lhs] - merged_text,
                         idx_arr[max_lhs + 1] - merged_text),
                     max_len);
}

int main()
{
    string s1 = "banana and pinapple",
           s2 = "apple and pinabanana";
