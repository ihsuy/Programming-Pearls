...
void WordWasher(string& word,
                const string ignore = "[]{}_-',.;:<>?!@*()\\\'\"") {
    string new_word;
...
vector<pair<string, int>> WordRank(const string& file_path,
                                   const int& rank_length = 10) {
