...
int main() {  // create test vector
    ...
    for (int i = 0, n = n_lower; i < sz; ++i) {
        ...
        if (rand() % 4) {  // occasionally introduce big gaps
            n += 1000;
        }
        nums.push_back(n);
    }
    ...
    for (int i = 0; i < nTest; ++i) {
        ...
        // printf(schema, res1.second , res2.second , res3.second ,
        // res4.second);
        if (res1.second != -1 or res2.second != -1 or res3.second != -1 or
            res4.second !=
                -1) {  // extremely rarely we can enter this if statement
        ...
        assert(res2.second < 0 or
               (nums[res2.second] == tar and nums[res2.second - 1] != tar));
        assert(res3.second < 0 or
               (nums[res3.second] == tar and nums[res3.second - 1] != tar));
        assert(res4.second < 0 or
               (nums[res4.second] == tar and nums[res4.second - 1] != tar));
    }
